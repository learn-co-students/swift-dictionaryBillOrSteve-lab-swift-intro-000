...
class ViewController: UIViewController {
    ...
    func createFacts() {
        let billFacts = [
            ...
            "He score 1590 (out of 1600) on his SATs.",
        ...
        let steveFacts = [
        "He took a calligraphy course, which he says was instrumental in the future company products' attention typography and fount.",
        "Shortly after being shooed out of his company, he applied to fly on the Space Shuttle as a civilian astronaut (he was rejected) and even considered starting a computer company in the Soviet Union.",
        "He actually served as a mentor for Google founder Sergey Brin and Larry Page, even sharing some of his advisers with the Google duo.",
