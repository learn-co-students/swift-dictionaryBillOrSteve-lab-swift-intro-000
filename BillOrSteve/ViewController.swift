...
class ViewController: UIViewController {
    ...
    @IBAction func stevesButton(_ sender: Any) {
        
        if (correctPerson == "Steve Jobs") {
        
        let count = Int(scoreCounter.text!)! + 1
    ...
    @IBAction func billsButton(_ sender: Any) {
