...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var steveButton: UILabel!
    
    @IBOutlet weak var billButton: UILabel!
    ...
    @IBAction func stevePicture(_ sender: Any) {
        ...
        @IBAction func billPicture(_ sender: Any) {
    ...
    func createFacts() {
        let billFacts = [
            ...
            "He scored 1590 (out of 1600) on his SATs.", "His foundation spends more on global health each year than the United Nation's World Health Organization.",
